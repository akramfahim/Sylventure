...
<head>
  <!-- Required meta tags -->
    ...
    <title>SYLVENTURE | Tour Sights</title>
</head>
<body>
  <header id="header">   
    <div class="container">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_lalakhal.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_ratargul.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_bisnakandhi.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_jaflong.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_lawachara.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_tonguarHaor.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_lovachora.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_khadim.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_srimangal.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <h3>Location</h3>
                    <p><iframe src="images/loc_jadukata.jpg" width="100%" height="200" frameborder="0" style="border:;" allowfullscreen=""></iframe></p>
                </div>
                <div class="col-12">
