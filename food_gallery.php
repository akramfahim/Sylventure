...
<head>
  <!-- Required meta tags -->
    ...
    <title>SYLVENTURE | Food Gallery</title>
</head>
<body>
  <header id="header">   
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg full-width">
          ...
          <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav">
              ...
              <li class="nav-item"><a href="food_gallery.php" class="nav-link active">Food Gallery</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center mb-3 site-animate">
            ...
            <h3 class="display-4">Our Trending Restaurent In Town </h3>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead">Here are the most popular restaurent in Sylhet.This restaurents are 
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center site-media site-animate border-0">
                  ...
                  <div class="media-body p-4">
                    ...
                    <h5 class="mt-0 h4">Spicy Restaurent</h5>
